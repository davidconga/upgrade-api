...
class PermissionTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $fleet_permissions = Permission::select('id')->whereIn('name', ['dashboard-menus','provider-list','provider-create','provider-edit','provider-delete','provider-status','provider-history','provider-statements','provider-rating','heat-map','god-eye','account-settings','change-password'])->get();
        ...
        $dispute_permissions = Permission::select('id')->whereIn('id', ['dispute-list','dispute-create','dispute-edit','dispute-delete','account-settings','change-password'])->get();
